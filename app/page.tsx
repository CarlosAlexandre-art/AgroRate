...
// Score gauge SVG (server component ok — sem interatividade)
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="pt-32 pb-24 px-6 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-20 left-10 w-80 h-80 bg-emerald-100 rounded-full blur-3xl opacity-30" />
          <div className="absolute bottom-0 right-10 w-96 h-96 bg-teal-50 rounded-full blur-3xl opacity-50" />
        </div>

        <div className="max-w-5xl mx-auto text-center relative">
          <div className="inline-flex items-center gap-2 bg-emerald-50 text-emerald-700 text-xs font-semibold px-4 py-2 rounded-full mb-8 border border-emerald-200 uppercase tracking-wider">
      ...
      <section className="px-6 pb-24">
        <div className="max-w-5xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden border border-slate-200 shadow-2xl shadow-slate-200">
            {/* Browser chrome */}
      ...
      <section id="como-funciona" className="px-6 py-24 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {STEPS.map(s => (
              <div key={s.step} className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm hover:shadow-md transition-shadow">
      ...
      <section id="score" className="px-6 py-24">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-5 mb-12">
            {LAYERS.map(l => (
              <div key={l.label} className="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all flex gap-5">
          ...
          <div className="bg-slate-900 rounded-3xl p-8 md:p-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {CATEGORIES.map(cat => (
                <div key={cat.label} className={`border-2 rounded-2xl p-4 ${cat.color}`}>
      ...
      <section className="px-6 py-24 bg-slate-50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {FEATURES.map(f => (
              <div key={f.title} className={`${f.color} rounded-2xl p-6 border border-white hover:shadow-lg hover:-translate-y-0.5 transition-all group`}>
                <div className={`${f.iconBg} w-12 h-12 rounded-xl flex items-center justify-center text-2xl mb-4`}>{f.icon}</div>
                <h3 className="font-bold text-slate-900 mb-2 text-base group-hover:text-[#065f46] transition-colors">{f.title}</h3>
      ...
      <section id="parceiros" className="px-6 py-24">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-10">
            {PARTNERS.map(p => (
              <div key={p.name} className={`border-2 rounded-2xl p-5 hover:shadow-md hover:-translate-y-0.5 transition-all ${p.color}`}>
            ...
            <div className="relative grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="grid grid-cols-1 gap-3">
                {[
                  ...
                  <div key={s.name} className={`border rounded-2xl p-4 ${s.color} ${s.active ? 'ring-2 ring-blue-500/30' : ''}`}>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div style={{ background: 'linear-gradient(135deg, #065f46 0%, #047857 100%)' }}
            ...
            <div className="relative">
              ...
              <Link href="/cadastro"
                className="inline-flex items-center gap-2 bg-white text-[#065f46] font-bold px-10 py-4 rounded-2xl hover:bg-emerald-50 transition-all shadow-2xl text-lg">
                Calcular meu score grátis →
              </Link>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-slate-400">
              <a href="#como-funciona" className="hover:text-slate-600 transition-colors">Como funciona</a>
              <a href="#score" className="hover:text-slate-600 transition-colors">O Score</a>
              <a href="#parceiros" className="hover:text-slate-600 transition-colors">Parceiros</a>
